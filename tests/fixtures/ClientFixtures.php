...
class ClientFixtures extends AbstractFixture
{
	...
	{
		$manager->persist(new Client('Karel Kos', '1973-11-02', 'kosik@seznam.cz', '732049293',
			new Address('Liborova 552', 'Praha', '16900', 'Česká republika')));

		$manager->persist(new Client('Petr Zapalač', '1962-07-28', 'p.zaplac@gmail.com', '604395382',
			new Address('Kapitána Jaroše 349', 'Teplice', '34552', 'Česká republika')));

		$manager->persist(new Client('Ondřej Hubený', '1985-12-27', 'ondrej.hubeny@centrum.cz', '777394827',
