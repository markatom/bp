Feature: Clients' management
  ...
  Scenario: Add new client
    ...
    When I follow "Detail Jan Novák" with xpath "//table/tbody/tr[9]/td[5]/a[1]"
  ...
  Scenario: Edit present client
    Given I am "John Doe"
    When I follow "clients"
    And I follow "Upravit Ondřej Hubený" with xpath "//table/tbody/tr[3]/td[5]/a[2]"
    And I fill in "fullName" with "Pavel Hubený"
    And I press "Uložit"
    Then I should see "Změny byly úspěšně uloženy."
    And I should see "Pavel Hubený"
    When I follow "Detail Pavel Hubený" with xpath "//table/tbody/tr[3]/td[5]/a[1]"
